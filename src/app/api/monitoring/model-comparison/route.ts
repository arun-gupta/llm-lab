      ...
      overall_recommendations: [
        {
          ...
          recommendation: 'Use GPT-3.5 Turbo for cost-sensitive applications',
          model_id: 'gpt-3.5-turbo'
        },
        {
          type: 'quality_optimization',
          recommendation: 'Use Claude 3 Opus for high-quality requirements',
          model_id: 'claude-3-opus'
        },
        {
          type: 'speed_optimization',
          recommendation: 'Use GPT-3.5 Turbo for time-sensitive applications',
          model_id: 'gpt-3.5-turbo'
        },
        {
          type: 'balanced_approach',
          recommendation: 'Use Claude 3 Sonnet for balanced performance',
          model_id: 'claude-3-sonnet'
        }
      ]
    };
